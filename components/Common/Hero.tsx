...
const Hero = () => {
  return (
    <section className="relative">
      <div className="relative grid min-h-screen w-full grid-cols-1 mx-auto gap-8 lg:gap-0  lg:grid-cols-6 px-4 py-20 lg:p-24 items-center justify-center">
        <div className="w-full lg:col-span-4   space-y-4 lg:space-y-8 lg:order-first lg:pt-10 ">
          ...
          <div className="relative flex justify-center  md:justify-start">
            <Button
              className="uppercase font-semibold hover:scale-110 duration-300 ease-in-out  text-xl"
              color="primary"
            ...
            <Image src="/images/icons/disco-ball.svg" className="absolute  top-12 left-28" alt="icon-img" width={100} height={100} />
          </div>
          <div className="">
        ...
        <div className="w-full lg:col-span-2 mx-auto text-center  relative lg:pt-10  order-first">
          <div className="relative w-full h-72 lg:h-[400px] overflow-hidden rounded-3xl shadow-white">
            <video
              autoPlay
              loop
              controls
