    ...
    <section className="px-4">
      <div className="relative isolate overflow-hidden   lg:py-16 my-10   lg:px-24 ">
        <div className="mx-auto  p-3 lg:p-10 rounded-xl bg-white/10">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8  gap-y-8 lg:gap-y-16 lg:max-w-none lg:grid-cols-2">
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-4 lg:gap-y-10 sm:grid-cols-2 lg:pt-2">
