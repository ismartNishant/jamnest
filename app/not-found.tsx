        ...
        <div className='min-h-[550px] flex items-center justify-center'>
            <div className='text-center max-w-screen-sm w-full p-10 rounded-2xl bg-white/5'>
                <div className='flex items-center justify-center text-primary'>
                    <div className='text-9xl md:text-[250px] font-bold'>
                        4
                    </div>
                    <div className='text-9xl md:text-[250px] font-bold'>
                        0
                ...
                <div className='mt-4 flex flex-col gap-4 items-center'>
                    ...
                    <Button color='primary' variant='bordered' className='text-lg uppercase font-medium' onClick={handleGoHome}>Got To Home</Button>
                </div>
            </div>
        </div>
    );
